...
.cg-gate-and .cg-gate-body,.cg-gate-and .cg-bubble{stroke:var(--d1,#2F63C9)}
.cg-gate-nand .cg-gate-body,.cg-gate-nand .cg-bubble{stroke:var(--d2,#7A4FBF)}
.cg-gate-or .cg-gate-body,.cg-gate-or .cg-bubble{stroke:var(--d5,#357A27)}
.cg-gate-nor .cg-gate-body,.cg-gate-nor .cg-bubble{stroke:var(--d4,#C0416E)}
.cg-gate-not .cg-gate-body,.cg-gate-not .cg-bubble{stroke:var(--d6,#9A5A2C)}
.cg-gate-xor .cg-gate-body,.cg-gate-xor .cg-bubble{stroke:var(--d3,#17786F)}
.cg-gate-xnor .cg-gate-body,.cg-gate-xnor .cg-bubble{stroke:var(--d2,#7A4FBF);stroke-dasharray:none}
.cg-bubble{fill:var(--well,#EAECEF);stroke-width:2}
.cg-wire{fill:none;stroke:var(--border-strong,#9AA1AB);stroke-width:1.5;stroke-linecap:round;stroke-linejoin:round}
.cg-wire-hl{stroke:var(--ink,#16181C) !important;stroke-width:2.5 !important}
.cg-highlight .cg-gate-body{stroke-width:3 !important}
.cg-label{font-family:var(--font-sans,system-ui,sans-serif);fill:var(--ink-2,#3D424A);pointer-events:none}
.cg-input-label{font-size:14px;font-weight:600;font-family:var(--font-mono,ui-monospace,monospace);fill:var(--ink,#16181C)}
.cg-output-label{font-size:14px;font-weight:600;fill:var(--ink,#16181C)}
.cg-gate-text{font-size:10px;font-weight:600;pointer-events:none}
.cg-junction{fill:var(--border-strong,#9AA1AB)}
.cg-tooltip{position:absolute;background:var(--ink,#16181C);color:var(--bg,#F4F5F7);border:0;border-radius:8px;padding:8px 12px;font-size:12px;line-height:1.5;font-family:var(--font-sans,system-ui,sans-serif);pointer-events:none;z-index:10;max-width:280px}
